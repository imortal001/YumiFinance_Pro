  ...
  return (
    <div className="relative min-h-screen bg-black overflow-x-hidden">
      ...
      >
        ...
        >
          Yumi Finance
          <motion.p variants={fadeInUp} className="text-xl font-mono mt-5" > Buy Now Pay Later Pay Back with Yield </motion.p>
        </motion.h1>
        
        <motion.button className="button bg-green-700 text-white px-4 py-2 rounded-md mt-10"><Link to="https://x.com/YumiFinance">Contact Us  </Link> </motion.button>
      </motion.div>
